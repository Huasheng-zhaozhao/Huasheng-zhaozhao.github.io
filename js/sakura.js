...
/* =====================================================
 * 🌗 监听 Butterfly Dark Mode
 * ===================================================== */

var weatherThemeObserver =
...
(function () {
     ...
     * 🌠 流星系统
     *
     * 只有 Dark Mode / 月亮状态下显示
     *
     * data-theme="dark"  → 显示流星
     * data-theme="light" → 隐藏流星
     * ===================================================== */
    ...
    function updateMeteorVisibility() {
...
/*页脚显示网站运行时间*/
//此处的时间改为自己的博客运行时间
const CREATE_TIME = new Date('2026-07-13T00:00:00').getTime();  //使用ISO 8601日期格式，兼容所有浏览器
const TIME_UNITS = [
